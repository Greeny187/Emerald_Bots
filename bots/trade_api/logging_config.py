"""
logging_config.py - Zentrale Logging-Konfiguration für Trade API Bot

Dieses Modul bietet eine zentrale Logging-Konfiguration für den Emerald Trade API Bot.
...
def setup_logging(
    ...
    """
    Konfiguriere zentrales Logging für Trade API Bot
    ...
    if log_file is None:
        log_file = os.getenv("TRADE_API_LOG_FILE", "trade_api_bot.log")
    ...
    logging.getLogger("bot.trade_api").setLevel(log_level)
    logging.getLogger("bot.trade_api.db").setLevel(log_level)
    logging.getLogger("bot.trade_api.handlers").setLevel(log_level)
    logging.getLogger("bot.trade_api.miniapp").setLevel(log_level)
    logging.getLogger("bot.trade_api.providers").setLevel(log_level)
    logging.getLogger("bot.trade_api.ml").setLevel(log_level)
    ...
    logging.info(f"[LOGGING] Trade API Bot logging initialized - level={level}")
